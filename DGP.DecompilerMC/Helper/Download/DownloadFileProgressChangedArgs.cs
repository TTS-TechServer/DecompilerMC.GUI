...
namespace DGP.Decompiler.Helper.Download
{
    ...
    /// </summary>
    internal class DownloadFileProgressChangedArgs : ProgressChangedEventArgs
    {
        /// <summary>
        ...
        internal DownloadFileProgressChangedArgs(int progressPercentage, long bytesReceived, long totalBytesToReceive)
        ...
        /// </summary>
        internal long TotalBytesToReceive { get; private set; }
    }
}