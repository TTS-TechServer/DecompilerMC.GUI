...
using DGP.Decompiler.Helper.Extensions;
using System;
...
namespace DGP.Decompiler.Helper.Download
{
    ...
    internal class DownloadWebClient : WebClient
    {
        ...
        internal bool IsPartialResponse
        {
            get
            {
        ...
        internal void OpenReadAsync(Uri address, long newPosition)
        {
            this.position = newPosition;
            OpenReadAsync(address);
        }

        internal string GetOriginalFileNameFromDownload()
        {
