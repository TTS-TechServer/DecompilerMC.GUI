...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.addButton(new Button(this.width / 2 - n2 / 2, RealmsParentalConsentScreen.row(11), n2, 20, translatableComponent2, button -> Util.getPlatform().openUri("https://minecraft.net/privacy/gdpr/")));
        this.addButton(new Button(this.width / 2 - (n + 5), RealmsParentalConsentScreen.row(13), n, 20, translatableComponent, button -> Util.getPlatform().openUri("https://minecraft.net/update-account")));
