...
implements TickableWidget {
    ...
    public void tick() {
        ...
        if (bl3) {
            ...
            string = realmsServer.minigameImage;
            ...
            string2 = realmsWorldOptions.getSlotName(this.slotIndex);
            l = realmsWorldOptions.templateId;
            string = realmsWorldOptions.templateImage;
            bl = realmsWorldOptions.empty;
        }
        Action action = RealmsWorldSlotButton.getAction(realmsServer, bl2, bl3);
        Pair<Component, Component> pair = this.getTooltipAndNarration(realmsServer, string2, bl, bl3, action);
        this.state = new State(bl2, string2, l, string, bl, bl3, action, (Component)pair.getFirst());
    ...
    private void drawSlotFrame(PoseStack poseStack, int n, int n2, int n3, int n4, boolean bl, String string, int n5, long l, @Nullable String string2, boolean bl2, boolean bl3, Action action, @Nullable Component component) {
        ...
        RealmsWorldSlotButton.drawCenteredString(poseStack, minecraft.font, string, n + 40, n2 + 66, 0xFFFFFF);
    }
