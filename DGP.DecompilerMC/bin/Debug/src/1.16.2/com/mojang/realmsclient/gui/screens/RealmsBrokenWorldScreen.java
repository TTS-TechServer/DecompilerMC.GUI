...
extends RealmsScreen {
    ...
    public void render(PoseStack poseStack, int n, int n2, float f) {
        ...
        for (int i = 0; i < this.message.length; ++i) {
            RealmsBrokenWorldScreen.drawCenteredString(poseStack, this.font, this.message[i], this.width / 2, RealmsBrokenWorldScreen.row(-1) + 3 + i * 12, 0xA0A0A0);
        }
        if (this.serverData == null) {
            return;
        }
    ...
    private void drawSlotFrame(PoseStack poseStack, int n, int n2, int n3, int n4, boolean bl, String string, int n5, long l, String string2, boolean bl2) {
        ...
        RealmsBrokenWorldScreen.drawCenteredString(poseStack, this.font, string, n + 40, n2 + 66, 0xFFFFFF);
    }
}
