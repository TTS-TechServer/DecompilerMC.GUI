...
extends RealmsScreen {
    ...
    private void checkDownloadSize() {
        ...
        if (!this.checked && this.getContentLength(this.worldDownload.downloadLink) >= 0x140000000L) {
            TranslatableComponent translatableComponent = new TranslatableComponent("mco.download.confirmation.line1", Unit.humanReadable(0x140000000L));
    ...
    private void drawDots(PoseStack poseStack) {
        ...
        this.font.draw(poseStack, DOTS[this.dotIndex % DOTS.length], (float)(this.width / 2 + n / 2 + 5), 50.0f, 0xFFFFFF);
    }
