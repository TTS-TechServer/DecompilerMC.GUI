...
extends RealmsScreen {
    ...
    private void drawPopup(PoseStack poseStack, int n, int n2) {
        ...
        this.formattedPopup.renderLeftAlignedNoShadow(poseStack, this.width / 2 + 52, n4 + 7, 10, 0x4C4C4C);
    }
    ...
    protected void renderMousehoverTooltip(PoseStack poseStack, List<Component> list, int n, int n2) {
        ...
        for (Component component : list) {
            ...
            this.font.drawShadow(poseStack, component, (float)n6, (float)(n7 + n3), 0xFFFFFF);
            n3 += 10;
        }
    }
    ...
    extends Entry {
        ...
        private void renderLegacy(RealmsServer realmsServer, PoseStack poseStack, int n, int n2, int n3, int n4) {
            ...
            if (!"0".equals(realmsServer.serverPing.nrOfPlayers)) {
                ...
                RealmsMainScreen.this.font.draw(poseStack, (String)object, (float)(n + 207 - RealmsMainScreen.this.font.width((String)object)), (float)(n2 + 3), 0x808080);
            ...
            if (RealmsMainScreen.this.isSelfOwnedServer(realmsServer) && realmsServer.expired) {
                ...
                if (realmsServer.worldType == RealmsServer.WorldType.MINIGAME) {
                    ...
                    RealmsMainScreen.this.font.draw(poseStack, SELECT_MINIGAME_PREFIX, (float)(n + 2), (float)(n2 + 12), 0xCCAC5C);
                    RealmsMainScreen.this.font.draw(poseStack, realmsServer.getMinigameName(), (float)(n + 2 + n16), (float)(n2 + 12), 0x6C6C6C);
                } else {
                    RealmsMainScreen.this.font.draw(poseStack, realmsServer.getDescription(), (float)(n + 2), (float)(n2 + 12), 0x6C6C6C);
                }
                if (!RealmsMainScreen.this.isSelfOwnedServer(realmsServer)) {
                    RealmsMainScreen.this.font.draw(poseStack, realmsServer.owner, (float)(n + 2), (float)(n2 + 12 + 11), 0x4C4C4C);
                }
            }
            RealmsMainScreen.this.font.draw(poseStack, realmsServer.getName(), (float)(n + 2), (float)(n2 + 1), 0xFFFFFF);
