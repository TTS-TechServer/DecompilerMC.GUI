...
public abstract class Particle {
    ...
    public Particle(ClientLevel clientLevel, double d, double d2, double d3, double d4, double d5, double d6) {
        ...
        this.xd = this.xd / (double)f2 * (double)f * (double)0.4f;
        this.yd = this.yd / (double)f2 * (double)f * (double)0.4f + (double)0.1f;
        this.zd = this.zd / (double)f2 * (double)f * (double)0.4f;
    }
