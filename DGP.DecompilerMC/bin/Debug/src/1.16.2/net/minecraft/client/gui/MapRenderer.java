        ...
        private void draw(PoseStack poseStack, MultiBufferSource multiBufferSource, boolean bl, int n) {
            ...
            for (MapDecoration mapDecoration : this.data.decorations.values()) {
                ...
                if (mapDecoration.getName() != null) {
                    ...
                    float f8 = 25.0f / f7;
                    font.getClass();
                    float f9 = Mth.clamp(f8, 0.0f, 6.0f / 9.0f);
                    poseStack.pushPose();
                    poseStack.translate(0.0f + (float)mapDecoration.getX() / 2.0f + 64.0f - f7 * f9 / 2.0f, 0.0f + (float)mapDecoration.getY() / 2.0f + 64.0f + 4.0f, -0.025f);
                    poseStack.scale(f9, f9, 1.0f);
