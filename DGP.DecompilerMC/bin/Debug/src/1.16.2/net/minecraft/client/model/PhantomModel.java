...
extends ListModel<T> {
    ...
    public void setupAnim(T t, float f, float f2, float f3, float f4, float f5) {
        ...
        float f7 = 16.0f;
        this.leftWingBase.zRot = Mth.cos(f6) * 16.0f * ((float)Math.PI / 180);
        this.leftWingTip.zRot = Mth.cos(f6) * 16.0f * ((float)Math.PI / 180);
        this.rightWingBase.zRot = -this.leftWingBase.zRot;
        this.rightWingTip.zRot = -this.leftWingTip.zRot;
        this.tailBase.xRot = -(5.0f + Mth.cos(f6 * 2.0f) * 5.0f) * ((float)Math.PI / 180);
        this.tailTip.xRot = -(5.0f + Mth.cos(f6 * 2.0f) * 5.0f) * ((float)Math.PI / 180);
    }
}
