...
implements MenuAccess<T> {
    ...
    public void render(PoseStack poseStack, int n, int n2, float f) {
        ...
        for (int i = 0; i < ((AbstractContainerMenu)this.menu).slots.size(); ++i) {
            ...
            this.fillGradient(poseStack, n4, n3, n4 + 16, n3 + 16, -2130706433, -2130706433);
        ...
        if (!((ItemStack)object).isEmpty()) {
            n4 = 8;
            n3 = this.draggingItem.isEmpty() ? 8 : 16;
            String string = null;
            ...
            this.renderFloatingItem((ItemStack)object, n - n5 - 8, n2 - n6 - n3, string);
        }
        if (!this.snapbackItem.isEmpty()) {
            ...
            n3 = this.snapbackEnd.x - this.snapbackStartX;
            int n9 = this.snapbackEnd.y - this.snapbackStartY;
            int n10 = this.snapbackStartX + (int)((float)n3 * f2);
