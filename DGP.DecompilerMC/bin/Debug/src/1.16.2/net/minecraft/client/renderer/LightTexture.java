    ...
    public void updateLightTexture(float f) {
        ...
        for (int i = 0; i < 16; ++i) {
            for (int j = 0; j < 16; ++j) {
                ...
                float f11 = f9 = this.getBrightness(clientLevel, j) * f6;
                float f12 = f9 * ((f9 * 0.6f + 0.4f) * 0.6f + 0.4f);
                float f13 = f9 * (f9 * f9 * 0.6f + 0.4f);
                ...
                if (f5 > 0.0f && (f7 = Math.max(vector3f2.x(), Math.max(vector3f2.y(), vector3f2.z()))) < 1.0f) {
                    f8 = 1.0f / f7;
                    vector3f3 = vector3f2.copy();
                    vector3f3.mul(f8);
