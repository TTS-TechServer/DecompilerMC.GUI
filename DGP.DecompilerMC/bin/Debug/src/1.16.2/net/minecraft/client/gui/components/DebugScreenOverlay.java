...
extends GuiComponent {
    ...
    private void drawChart(PoseStack poseStack, FrameTimer frameTimer, int n, int n2, boolean bl) {
        ...
        if (bl) {
            ...
            this.font.draw(poseStack, "60 FPS", (float)(n + 2), (float)(n3 - 30 + 2), 0xE0E0E0);
            this.hLine(poseStack, n, n + n9 - 1, n3 - 30, -1);
            DebugScreenOverlay.fill(poseStack, n + 1, n3 - 60 + 1, n + 14, n3 - 60 + 10, -1873784752);
            this.font.draw(poseStack, "30 FPS", (float)(n + 2), (float)(n3 - 60 + 2), 0xE0E0E0);
            this.hLine(poseStack, n, n + n9 - 1, n3 - 60, -1);
        } else {
            DebugScreenOverlay.fill(poseStack, n + 1, n3 - 60 + 1, n + 14, n3 - 60 + 10, -1873784752);
            this.font.draw(poseStack, "20 TPS", (float)(n + 2), (float)(n3 - 60 + 2), 0xE0E0E0);
            this.hLine(poseStack, n, n + n9 - 1, n3 - 60, -1);
        }
        ...
        float f = n + 2;
        this.font.getClass();
        this.font.drawShadow(poseStack, string, f, (float)(n3 - 60 - 9), 0xE0E0E0);
        float f2 = n + n9 / 2 - this.font.width(string2) / 2;
        this.font.getClass();
        this.font.drawShadow(poseStack, string2, f2, (float)(n3 - 60 - 9), 0xE0E0E0);
        float f3 = n + n9 - this.font.width(string3);
        this.font.getClass();
        this.font.drawShadow(poseStack, string3, f3, (float)(n3 - 60 - 9), 0xE0E0E0);
