...
extends Screen {
    ...
    public void render(PoseStack poseStack, int n, int n2, float f) {
        ...
        this.font.draw(poseStack, this.title, (float)n3, (float)n4, 0x1F1F1F);
        n4 = this.movementMessage.renderLeftAlignedNoShadow(poseStack, n3, n4 + 12, 12, 0x4F4F4F);
        this.font.getClass();
        this.durationMessage.renderLeftAlignedNoShadow(poseStack, n3, n4 + 20, 9, 0x1F1F1F);
