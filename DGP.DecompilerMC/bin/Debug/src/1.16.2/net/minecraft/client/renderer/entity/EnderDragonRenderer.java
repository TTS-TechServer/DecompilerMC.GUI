...
extends EntityRenderer<EnderDragon> {
    ...
    extends EntityModel<EnderDragon> {
        ...
        public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int n, int n2, float f, float f2, float f3, float f4) {
            ...
            this.jaw.xRot = (float)(Math.sin(f6 * ((float)Math.PI * 2)) + 1.0) * 0.2f;
            ...
            for (int i = 0; i < 5; ++i) {
                ...
                this.neck.yRot = Mth.rotWrap(arrd2[0] - arrd[0]) * ((float)Math.PI / 180) * 1.5f;
                this.neck.xRot = f5 + this.entity.getHeadPartYOffset(i, arrd, arrd2) * ((float)Math.PI / 180) * 1.5f * 5.0f;
                this.neck.zRot = -Mth.rotWrap(arrd2[0] - (double)f13) * ((float)Math.PI / 180) * 1.5f;
                this.neck.y = f9;
                this.neck.z = f10;
                this.neck.x = f8;
            ...
            this.head.yRot = Mth.rotWrap(arrd3[0] - arrd[0]) * ((float)Math.PI / 180);
            this.head.xRot = Mth.rotWrap(this.entity.getHeadPartYOffset(6, arrd, arrd3)) * ((float)Math.PI / 180) * 1.5f * 5.0f;
            this.head.zRot = -Mth.rotWrap(arrd3[0] - (double)f13) * ((float)Math.PI / 180);
            ...
            for (int i = 0; i < 12; ++i) {
                ...
                this.neck.yRot = (Mth.rotWrap(arrd3[0] - arrd[0]) * 1.5f + 180.0f) * ((float)Math.PI / 180);
                this.neck.xRot = f5 + (float)(arrd3[1] - arrd[1]) * ((float)Math.PI / 180) * 1.5f * 5.0f;
                this.neck.zRot = Mth.rotWrap(arrd3[0] - (double)f13) * ((float)Math.PI / 180) * 1.5f;
                this.neck.y = f9;
                this.neck.z = f10;
                this.neck.x = f8;
                f9 = (float)((double)f9 + Math.sin(this.neck.xRot) * 10.0);
