...
extends ContainerObjectSelectionList<Entry> {
    ...
    extends Entry {
        ...
        public void render(PoseStack poseStack, int n, int n2, int n3, int n4, int n5, int n6, int n7, boolean bl, float f) {
            ...
            float f2 = n3 + 90 - ControlList.this.maxNameWidth;
            int n8 = n2 + n5 / 2;
            ((ControlList)ControlList.this).minecraft.font.getClass();
            ((ControlList)ControlList.this).minecraft.font.draw(poseStack, this.name, f2, (float)(n8 - 9 / 2), 0xFFFFFF);
    ...
    extends Entry {
        ...
        public void render(PoseStack poseStack, int n, int n2, int n3, int n4, int n5, int n6, int n7, boolean bl, float f) {
            ...
            ((ControlList)ControlList.this).minecraft.font.getClass();
            ((ControlList)ControlList.this).minecraft.font.draw(poseStack, this.name, f2, (float)(n2 + n5 - 9 - 1), 0xFFFFFF);
        }
