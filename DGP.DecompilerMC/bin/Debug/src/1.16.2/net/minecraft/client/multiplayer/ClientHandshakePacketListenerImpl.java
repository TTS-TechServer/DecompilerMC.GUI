...
implements ClientLoginPacketListener {
    ...
    public void handleHello(ClientboundHelloPacket clientboundHelloPacket) {
        ...
        HttpUtil.DOWNLOAD_EXECUTOR.submit(() -> {
            ...
            this.connection.send(serverboundKeyPacket, (GenericFutureListener<? extends Future<? super Void>>)((GenericFutureListener)future -> this.connection.setEncryptionKey(secretKey)));
        });
    }
