        ...
        if (super.mouseClicked(d, d2, n)) {
            ...
            if (this.gpuWarnlistManager.isShowingWarning()) {
                ...
                if ((string2 = this.gpuWarnlistManager.getVendorWarnings()) != null) {
                    arrayList.add(NEW_LINE);
                    arrayList.add(new TranslatableComponent("options.graphics.warning.vendor", string2).withStyle(ChatFormatting.GRAY));
                }
                if ((string = this.gpuWarnlistManager.getVersionWarnings()) != null) {
                    arrayList.add(NEW_LINE);
                    arrayList.add(new TranslatableComponent("options.graphics.warning.version", string).withStyle(ChatFormatting.GRAY));
                }
