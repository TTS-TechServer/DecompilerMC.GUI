    ...
    public void setupAnim(T t, float f, float f2, float f3, float f4, float f5) {
        ...
        if (this.state != 3) {
            ...
            if (this.state == 2) {
                ...
                this.frontLegL.xRot = Mth.cos(f * 0.6662f + (float)Math.PI + 0.3f) * f2;
                this.frontLegR.xRot = Mth.cos(f * 0.6662f + (float)Math.PI) * f2;
                this.tail2.xRot = 1.7278761f + 0.31415927f * Mth.cos(f) * f2;
            } else {
                this.backLegL.xRot = Mth.cos(f * 0.6662f) * f2;
                this.backLegR.xRot = Mth.cos(f * 0.6662f + (float)Math.PI) * f2;
                this.frontLegL.xRot = Mth.cos(f * 0.6662f + (float)Math.PI) * f2;
