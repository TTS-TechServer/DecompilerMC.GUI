...
Widget {
    ...
    public void renderTooltip(PoseStack poseStack, List<? extends FormattedCharSequence> list, int n, int n2) {
        ...
        for (FormattedCharSequence formattedCharSequence : list) {
            n4 = this.font.width(formattedCharSequence);
            if (n4 <= n42) continue;
            n42 = n4;
        }
        int n5 = n + 12;
        ...
        Screen.fillGradient(matrix4f, bufferBuilder, n5 - 3, n3 - 4, n5 + n4 + 3, n3 - 3, 400, -267386864, -267386864);
        Screen.fillGradient(matrix4f, bufferBuilder, n5 - 3, n3 + n7 + 3, n5 + n4 + 3, n3 + n7 + 4, 400, -267386864, -267386864);
        Screen.fillGradient(matrix4f, bufferBuilder, n5 - 3, n3 - 3, n5 + n4 + 3, n3 + n7 + 3, 400, -267386864, -267386864);
        Screen.fillGradient(matrix4f, bufferBuilder, n5 - 4, n3 - 3, n5 - 3, n3 + n7 + 3, 400, -267386864, -267386864);
        Screen.fillGradient(matrix4f, bufferBuilder, n5 + n4 + 3, n3 - 3, n5 + n4 + 4, n3 + n7 + 3, 400, -267386864, -267386864);
        Screen.fillGradient(matrix4f, bufferBuilder, n5 - 3, n3 - 3 + 1, n5 - 3 + 1, n3 + n7 + 3 - 1, 400, 0x505000FF, 1344798847);
        Screen.fillGradient(matrix4f, bufferBuilder, n5 + n4 + 2, n3 - 3 + 1, n5 + n4 + 3, n3 + n7 + 3 - 1, 400, 0x505000FF, 1344798847);
        Screen.fillGradient(matrix4f, bufferBuilder, n5 - 3, n3 - 3, n5 + n4 + 3, n3 - 3 + 1, 400, 0x505000FF, 0x505000FF);
        Screen.fillGradient(matrix4f, bufferBuilder, n5 - 3, n3 + n7 + 2, n5 + n4 + 3, n3 + n7 + 3, 400, 1344798847, 1344798847);
        ...
        for (int i = 0; i < list.size(); ++i) {
            ...
            if (formattedCharSequence != null) {
                void var7_11;
                this.font.drawInBatch(formattedCharSequence, (float)n5, (float)var7_11, -1, true, matrix4f, (MultiBufferSource)bufferSource, false, 0, 0xF000F0);
            }
            if (i == 0) {
                var7_11 += 2;
            }
