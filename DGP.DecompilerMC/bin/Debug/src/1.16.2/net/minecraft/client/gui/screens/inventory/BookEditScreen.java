...
extends Screen {
    ...
    private DisplayCache rebuildDisplayCache() {
        ...
        if (bl && mutableBoolean.isTrue()) {
            ...
            this.font.getClass();
            pos2i = new Pos2i(0, n4 * 9);
        } else {
            int n5 = BookEditScreen.findLineFromPos(arrn, n2);
            n = this.font.width(string.substring(arrn[n5], n2));
            this.font.getClass();
            pos2i = new Pos2i(n, n5 * 9);
        }
        ...
        if (n2 != n3) {
            ...
            int n8 = BookEditScreen.findLineFromPos(arrn, n);
            if (n8 == (n6 = BookEditScreen.findLineFromPos(arrn, n7))) {
                this.font.getClass();
                int n9 = n8 * 9;
                int n10 = arrn[n8];
                arrayList2.add(this.createPartialLineSelection(string, stringSplitter, n, n7, n9, n10));
            } else {
                int n11 = n8 + 1 > arrn.length ? string.length() : arrn[n8 + 1];
                this.font.getClass();
                arrayList2.add(this.createPartialLineSelection(string, stringSplitter, n, n11, n8 * 9, arrn[n8]));
                for (int i = n8 + 1; i < n6; ++i) {
                    this.font.getClass();
                    int n12 = i * 9;
                    String string2 = string.substring(arrn[i], arrn[i + 1]);
                    int n13 = (int)stringSplitter.stringWidth(string2);
                    Pos2i pos2i2 = new Pos2i(0, n12);
                    this.font.getClass();
                    arrayList2.add(this.createSelection(pos2i2, new Pos2i(n13, n12 + 9)));
                }
                int n14 = arrn[n6];
                this.font.getClass();
                arrayList2.add(this.createPartialLineSelection(string, stringSplitter, n14, n7, n6 * 9, arrn[n6]));
            }
        }
    ...
    private Rect2i createPartialLineSelection(String string, StringSplitter stringSplitter, int n, int n2, int n3, int n4) {
        ...
        int n5 = (int)stringSplitter.stringWidth(string3);
        this.font.getClass();
        Pos2i pos2i2 = new Pos2i(n5, n3 + 9);
