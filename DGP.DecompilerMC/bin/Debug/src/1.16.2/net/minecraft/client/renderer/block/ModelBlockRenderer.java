...
public class ModelBlockRenderer {
    ...
    private void putQuadData(BlockAndTintGetter blockAndTintGetter, BlockState blockState, BlockPos blockPos, VertexConsumer vertexConsumer, PoseStack.Pose pose, BakedQuad bakedQuad, float f, float f2, float f3, float f4, int n, int n2, int n3, int n4, int n5) {
        ...
        if (bakedQuad.isTinted()) {
            ...
            f6 = (float)(n6 >> 8 & 0xFF) / 255.0f;
            f5 = (float)(n6 & 0xFF) / 255.0f;
        } else {
            f7 = 1.0f;
            f6 = 1.0f;
            f5 = 1.0f;
        }
        vertexConsumer.putBulkData(pose, bakedQuad, new float[]{f, f2, f3, f4}, f7, f6, f5, new int[]{n, n2, n3, n4}, n5, true);
    }
    ...
    private static void renderQuadList(PoseStack.Pose pose, VertexConsumer vertexConsumer, float f, float f2, float f3, List<BakedQuad> list, int n, int n2) {
        for (BakedQuad bakedQuad : list) {
            ...
            vertexConsumer.putBulkData(pose, bakedQuad, f6, f5, f4, n, n2);
        }
    }
    ...
    class AmbientOcclusionFace {
        ...
        public void calculate(BlockAndTintGetter blockAndTintGetter, BlockState blockState, BlockPos blockPos, Direction direction, float[] arrf, BitSet bitSet, boolean bl) {
            ...
            if (bl5 || bl3) {
                ...
                f8 = cache.getShadeBrightness(blockState2, blockAndTintGetter, mutableBlockPos);
            ...
            if (bl5 || bl4) {
                ...
                blockState2 = blockAndTintGetter.getBlockState(mutableBlockPos);
                f6 = cache.getShadeBrightness(blockState2, blockAndTintGetter, mutableBlockPos);
            ...
            if (!bitSet.get(1) || !adjacencyInfo.doNonCubicWeight) {
                f4 = (f12 + f9 + f7 + f13) * 0.25f;
                f3 = (f11 + f9 + f8 + f13) * 0.25f;
                f2 = (f11 + f10 + f6 + f13) * 0.25f;
                f = (f12 + f10 + f5 + f13) * 0.25f;
                this.lightmap[((AmbientVertexRemap)ambientVertexRemap).vert0] = this.blend(n8, n5, n3, n9);
                this.lightmap[((AmbientVertexRemap)ambientVertexRemap).vert1] = this.blend(n7, n5, n4, n9);
                this.lightmap[((AmbientVertexRemap)ambientVertexRemap).vert2] = this.blend(n7, n6, n2, n9);
                this.lightmap[((AmbientVertexRemap)ambientVertexRemap).vert3] = this.blend(n8, n6, n, n9);
                this.brightness[((AmbientVertexRemap)ambientVertexRemap).vert0] = f4;
                this.brightness[((AmbientVertexRemap)ambientVertexRemap).vert1] = f3;
                this.brightness[((AmbientVertexRemap)ambientVertexRemap).vert2] = f2;
                this.brightness[((AmbientVertexRemap)ambientVertexRemap).vert3] = f;
            } else {
                f4 = (f12 + f9 + f7 + f13) * 0.25f;
                f3 = (f11 + f9 + f8 + f13) * 0.25f;
                f2 = (f11 + f10 + f6 + f13) * 0.25f;
                ...
                this.brightness[((AmbientVertexRemap)ambientVertexRemap).vert0] = f4 * f14 + f3 * f15 + f2 * f16 + f * f17;
                this.brightness[((AmbientVertexRemap)ambientVertexRemap).vert1] = f4 * f18 + f3 * f19 + f2 * f20 + f * f21;
                this.brightness[((AmbientVertexRemap)ambientVertexRemap).vert2] = f4 * f22 + f3 * f23 + f2 * f24 + f * f25;
                this.brightness[((AmbientVertexRemap)ambientVertexRemap).vert3] = f4 * f26 + f3 * f27 + f2 * f28 + f * f29;
                int n10 = this.blend(n8, n5, n3, n9);
                int n11 = this.blend(n7, n5, n4, n9);
                int n12 = this.blend(n7, n6, n2, n9);
                int n13 = this.blend(n8, n6, n, n9);
                this.lightmap[((AmbientVertexRemap)ambientVertexRemap).vert0] = this.blend(n10, n11, n12, n13, f14, f15, f16, f17);
                this.lightmap[((AmbientVertexRemap)ambientVertexRemap).vert1] = this.blend(n10, n11, n12, n13, f18, f19, f20, f21);
                this.lightmap[((AmbientVertexRemap)ambientVertexRemap).vert2] = this.blend(n10, n11, n12, n13, f22, f23, f24, f25);
                this.lightmap[((AmbientVertexRemap)ambientVertexRemap).vert3] = this.blend(n10, n11, n12, n13, f26, f27, f28, f29);
            }
            f4 = blockAndTintGetter.getShade(direction, bl);
            int n14 = 0;
            while (n14 < this.brightness.length) {
                int n15 = n14++;
                this.brightness[n15] = this.brightness[n15] * f4;
            }
        }
