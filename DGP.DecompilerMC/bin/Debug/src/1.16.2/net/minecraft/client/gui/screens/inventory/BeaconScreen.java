...
extends AbstractContainerScreen<BeaconMenu> {
    ...
    public void tick() {
        ...
        if (this.initPowerButtons && n >= 0) {
            ...
            for (n5 = 0; n5 <= 2; ++n5) {
                n4 = BeaconBlockEntity.BEACON_EFFECTS[n5].length;
                n3 = n4 * 22 + (n4 - 1) * 2;
                for (n2 = 0; n2 < n4; ++n2) {
                    mobEffect = BeaconBlockEntity.BEACON_EFFECTS[n5][n2];
                    beaconPowerButton = new BeaconPowerButton(this.leftPos + 76 + n2 * 24 - n3 / 2, this.topPos + 22 + n5 * 25, mobEffect, true);
            ...
            n3 = n4 * 22 + (n4 - 1) * 2;
            for (n2 = 0; n2 < n4 - 1; ++n2) {
                mobEffect = BeaconBlockEntity.BEACON_EFFECTS[3][n2];
                beaconPowerButton = new BeaconPowerButton(this.leftPos + 167 + n2 * 24 - n3 / 2, this.topPos + 47, mobEffect, false);
                this.addButton(beaconPowerButton);
                if (3 >= n) {
                    beaconPowerButton.active = false;
                    continue;
            ...
            if (this.primary != null) {
                BeaconPowerButton beaconPowerButton2 = new BeaconPowerButton(this.leftPos + 167 + (n4 - 1) * 24 - n3 / 2, this.topPos + 47, this.primary, false);
