...
implements StatsUpdateListener {
    ...
    public void render(PoseStack poseStack, int n, int n2, float f) {
        if (this.isLoading) {
            ...
            this.font.getClass();
            StatsScreen.drawCenteredString(poseStack, this.font, string, n3, n4 + 9 * 2, 0xFFFFFF);
        } else {
    ...
    extends ObjectSelectionList<MobRow> {
        ...
        extends ObjectSelectionList.Entry<MobRow> {
            ...
            public void render(PoseStack poseStack, int n, int n2, int n3, int n4, int n5, int n6, int n7, boolean bl, float f) {
                GuiComponent.drawString(poseStack, StatsScreen.this.font, this.mobName, n3 + 2, n2 + 1, 0xFFFFFF);
                Font font = StatsScreen.this.font;
                StatsScreen.this.font.getClass();
                GuiComponent.drawString(poseStack, font, this.kills, n3 + 2 + 10, n2 + 1 + 9, this.hasKills ? 0x909090 : 0x606060);
                Font font2 = StatsScreen.this.font;
                StatsScreen.this.font.getClass();
                GuiComponent.drawString(poseStack, font2, this.killedBy, n3 + 2 + 10, n2 + 1 + 9 * 2, this.wasKilledBy ? 0x909090 : 0x606060);
            }
        }
    }
    ...
    extends ObjectSelectionList<ItemRow> {
        ...
        extends ObjectSelectionList.Entry<ItemRow> {
            ...
            public void render(PoseStack poseStack, int n, int n2, int n3, int n4, int n5, int n6, int n7, boolean bl, float f) {
                int n8;
                Item item = ((StatsScreen)StatsScreen.this).itemStatsList.statItemList.get(n);
                StatsScreen.this.blitSlot(poseStack, n3 + 40, n2, item);
                for (n8 = 0; n8 < ((StatsScreen)StatsScreen.this).itemStatsList.blockColumns.size(); ++n8) {
                    Stat<Block> stat = item instanceof BlockItem ? ((StatsScreen)StatsScreen.this).itemStatsList.blockColumns.get(n8).get(((BlockItem)item).getBlock()) : null;
                    this.renderStat(poseStack, stat, n3 + StatsScreen.this.getColumnX(n8), n2, n % 2 == 0);
                }
                for (n8 = 0; n8 < ((StatsScreen)StatsScreen.this).itemStatsList.itemColumns.size(); ++n8) {
                    this.renderStat(poseStack, ((StatsScreen)StatsScreen.this).itemStatsList.itemColumns.get(n8).get(item), n3 + StatsScreen.this.getColumnX(n8 + ((StatsScreen)StatsScreen.this).itemStatsList.blockColumns.size()), n2, n % 2 == 0);
                }
            }
            ...
            protected void renderStat(PoseStack poseStack, @Nullable Stat<?> stat, int n, int n2, boolean bl) {
                ...
                GuiComponent.drawString(poseStack, StatsScreen.this.font, string, n - StatsScreen.this.font.width(string), n2 + 5, bl ? 0xFFFFFF : 0x909090);
            }
        }
    ...
    extends ObjectSelectionList<Entry> {
        ...
        extends ObjectSelectionList.Entry<Entry> {
            ...
            @Override
            public void render(PoseStack poseStack, int n, int n2, int n3, int n4, int n5, int n6, int n7, boolean bl, float f) {
                GuiComponent.drawString(poseStack, StatsScreen.this.font, this.statDisplay, n3 + 2, n2 + 1, n % 2 == 0 ? 0xFFFFFF : 0x909090);
                String string = this.stat.format(StatsScreen.this.stats.getValue(this.stat));
                GuiComponent.drawString(poseStack, StatsScreen.this.font, string, n3 + 2 + 213 - StatsScreen.this.font.width(string), n2 + 1, n % 2 == 0 ? 0xFFFFFF : 0x909090);
            }
        }
    }
}
