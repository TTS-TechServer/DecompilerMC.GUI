...
extends AgeableListModel<T> {
    ...
    public void setupAnim(T t, float f, float f2, float f3, float f4, float f5) {
        ...
        if (bl) {
            ...
            this.rightWing.zRot = Mth.cos(f6) * (float)Math.PI * 0.15f;
        ...
        if (!t.isAngry()) {
            ...
            if (!bl) {
                ...
                this.frontLeg.xRot = -f6 * (float)Math.PI * 0.1f + 0.3926991f;
                this.backLeg.xRot = -f6 * (float)Math.PI * 0.05f + 0.7853982f;
