...
implements PreparableReloadListener {
    ...
    public CompletableFuture<Void> reload(PreparableReloadListener.PreparationBarrier preparationBarrier, ResourceManager resourceManager, ProfilerFiller profilerFiller, ProfilerFiller profilerFiller2, Executor executor, Executor executor2) {
        ...
        CompletableFuture[] arrcompletableFuture = (CompletableFuture[])Registry.PARTICLE_TYPE.keySet().stream().map(resourceLocation -> CompletableFuture.runAsync(() -> this.loadParticleDescription(resourceManager, (ResourceLocation)resourceLocation, concurrentMap), executor)).toArray(CompletableFuture[]::new);
