...
extends Screen {
    ...
    protected void init() {
        ...
        this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 120 + 5, 200, 20, new TranslatableComponent("selectWorld.edit.export_worldgen_settings"), button -> {
            ...
            try {
                object2 = this.minecraft.makeServerStem(registryHolder, Minecraft::loadDataPacks, (Function4<LevelStorageSource.LevelStorageAccess, RegistryAccess.RegistryHolder, ResourceManager, DataPackConfig, WorldData>)((Function4)Minecraft::loadWorldData), false, this.levelAccess);
                object = null;
                try {
                    RegistryWriteOps registryWriteOps = RegistryWriteOps.create(JsonOps.INSTANCE, registryHolder);
                    DataResult dataResult2 = WorldGenSettings.CODEC.encodeStart(registryWriteOps, (Object)((Minecraft.ServerStem)object2).worldData().worldGenSettings());
                    ...
                    if (object2 != null) {
                        if (object != null) {
                            try {
                                ((Minecraft.ServerStem)object2).close();
                            }
                            catch (Throwable throwable) {
            ...
            object2 = new TextComponent((String)dataResult.get().map(Function.identity(), DataResult.PartialResult::message));
            object = new TranslatableComponent(dataResult.result().isPresent() ? "selectWorld.edit.export_worldgen_settings.success" : "selectWorld.edit.export_worldgen_settings.failure");
            dataResult.error().ifPresent(partialResult -> LOGGER.error("Error exporting world settings: {}", partialResult));
            this.minecraft.getToasts().addToast(SystemToast.multiline(this.minecraft, SystemToast.SystemToastIds.WORLD_GEN_SETTINGS_TRANSFER, (Component)object, (Component)object2));
        }));
