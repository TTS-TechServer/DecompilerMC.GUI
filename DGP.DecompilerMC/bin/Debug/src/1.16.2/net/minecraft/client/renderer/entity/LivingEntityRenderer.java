...
implements RenderLayerParent<T, M> {
    ...
    public void render(T t, float f, float f2, PoseStack poseStack, MultiBufferSource multiBufferSource, int n) {
        ...
        float f4 = Mth.rotLerp(f2, ((LivingEntity)t).yBodyRotO, ((LivingEntity)t).yBodyRot);
        float f5 = Mth.rotLerp(f2, ((LivingEntity)t).yHeadRotO, ((LivingEntity)t).yHeadRot);
        float f6 = f5 - f4;
        if (((Entity)t).isPassenger() && ((Entity)t).getVehicle() instanceof LivingEntity) {
            ...
            f4 = Mth.rotLerp(f2, livingEntity.yBodyRotO, livingEntity.yBodyRot);
            f6 = f5 - f4;
            float f7 = Mth.wrapDegrees(f6);
            if (f7 < -85.0f) {
                f7 = -85.0f;
            }
            if (f7 >= 85.0f) {
        ...
        if (((Entity)t).getPose() == Pose.SLEEPING && (direction = ((LivingEntity)t).getBedOrientation()) != null) {
            ...
            poseStack.translate((float)(-direction.getStepX()) * f3, 0.0, (float)(-direction.getStepZ()) * f3);
        }
        float f9 = this.getBob(t, f2);
        this.setupRotations(t, poseStack, f9, f4, f2);
        ...
        if (!((Entity)t).isPassenger() && ((LivingEntity)t).isAlive()) {
            f3 = Mth.lerp(f2, ((LivingEntity)t).animationSpeedOld, ((LivingEntity)t).animationSpeed);
            f10 = ((LivingEntity)t).animationPosition - ((LivingEntity)t).animationSpeed * (1.0f - f2);
        ...
        ((EntityModel)this.model).prepareMobModel(t, f10, f3, f2);
        ((EntityModel)this.model).setupAnim(t, f10, f3, f9, f6, f8);
        ...
        if (!((Entity)t).isSpectator()) {
            for (RenderLayer renderLayer : this.layers) {
                renderLayer.render(poseStack, multiBufferSource, n, t, f10, f3, f2, f9, f6, f8);
            }
        }
        poseStack.popPose();
    ...
    protected void setupRotations(T t, PoseStack poseStack, float f, float f2, float f3) {
        ...
        Pose pose;
        if (this.isShaking(t)) {
            f2 += (float)(Math.cos((double)((LivingEntity)t).tickCount * 3.25) * Math.PI * (double)0.4f);
        }
