        ...
        for (n5 = 0; n5 < this.lines.size(); ++n5) {
            ...
            if ((float)n9 + f2 + 12.0f + 8.0f > 0.0f && (float)n9 + f2 < (float)this.height) {
                ...
                if (this.centeredLines.contains(n5)) {
                    this.font.drawShadow(poseStack, formattedCharSequence, (float)(n7 + (274 - this.font.width(formattedCharSequence)) / 2), (float)n9, 0xFFFFFF);
                } else {
                    this.font.random.setSeed((long)((float)((long)n5 * 4238972211L) + this.time / 4.0f));
                    this.font.drawShadow(poseStack, formattedCharSequence, (float)n7, (float)n9, 0xFFFFFF);
                }
            }
            n9 += 12;
        }
