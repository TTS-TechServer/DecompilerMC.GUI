...
extends EntityModel<T> {
    ...
    public void setupAnim(T t, float f, float f2, float f3, float f4, float f5) {
        ...
        this.nose.xRot = f5 * ((float)Math.PI / 180);
        this.head.xRot = f5 * ((float)Math.PI / 180);
        this.earRight.xRot = f5 * ((float)Math.PI / 180);
        this.earLeft.xRot = f5 * ((float)Math.PI / 180);
        this.nose.yRot = f4 * ((float)Math.PI / 180);
        ...
        this.jumpRotation = Mth.sin(((Rabbit)t).getJumpCompletion(f6) * (float)Math.PI);
    ...
    public void prepareMobModel(T t, float f, float f2, float f3) {
        ...
        this.jumpRotation = Mth.sin(((Rabbit)t).getJumpCompletion(f3) * (float)Math.PI);
    }
}
