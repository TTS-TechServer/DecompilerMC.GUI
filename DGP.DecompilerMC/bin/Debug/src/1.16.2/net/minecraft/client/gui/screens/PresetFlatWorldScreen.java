    ...
    extends ObjectSelectionList<Entry> {
        ...
        extends ObjectSelectionList.Entry<Entry> {
            ...
            public void render(PoseStack poseStack, int n, int n2, int n3, int n4, int n5, int n6, int n7, boolean bl, float f) {
                ...
                PresetFlatWorldScreen.this.font.draw(poseStack, presetInfo.name, (float)(n3 + 18 + 5), (float)(n2 + 6), 0xFFFFFF);
            }
            ...
            private void select() {
                ...
                WritableRegistry<Biome> writableRegistry = ((PresetFlatWorldScreen)PresetFlatWorldScreen.this).parent.parent.worldGenSettingsComponent.registryHolder().registryOrThrow(Registry.BIOME_REGISTRY);
