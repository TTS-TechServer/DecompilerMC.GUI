    ...
    public void setupAnim(T t, float f, float f2, float f3, float f4, float f5) {
        ...
        if (t instanceof AbstractPiglin) {
            ...
            if (piglinArmPose == PiglinArmPose.DANCING) {
                float f9 = f3 / 60.0f;
                this.earLeft.zRot = 0.5235988f + (float)Math.PI / 180 * Mth.sin(f9 * 30.0f) * 10.0f;
                this.earRight.zRot = -0.5235988f - (float)Math.PI / 180 * Mth.cos(f9 * 30.0f) * 10.0f;
                this.head.x = Mth.sin(f9 * 10.0f);
                this.head.y = Mth.sin(f9 * 40.0f) + 0.4f;
                this.rightArm.zRot = (float)Math.PI / 180 * (70.0f + Mth.cos(f9 * 40.0f) * 10.0f);
