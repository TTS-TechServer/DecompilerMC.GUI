...
extends ObjectSelectionList<PackEntry> {
    ...
    protected void renderHeader(PoseStack poseStack, int n, int n2, Tesselator tesselator) {
        ...
        this.minecraft.font.draw(poseStack, mutableComponent, (float)(n + this.width / 2 - this.minecraft.font.width(mutableComponent) / 2), (float)Math.min(this.y0 + 3, n2), 0xFFFFFF);
    }
    ...
    extends ObjectSelectionList.Entry<PackEntry> {
        ...
        public void render(PoseStack poseStack, int n, int n2, int n3, int n4, int n5, int n6, int n7, boolean bl, float f) {
            ...
            this.minecraft.font.drawShadow(poseStack, formattedCharSequence, (float)(n3 + 32 + 2), (float)(n2 + 1), 0xFFFFFF);
            multiLineLabel.renderLeftAligned(poseStack, n3 + 32 + 2, n2 + 12, 10, 0x808080);
        }
