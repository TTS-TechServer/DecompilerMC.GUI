...
public class WeightedConfiguredFeature {
    public static final Codec<WeightedConfiguredFeature> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)ConfiguredFeature.CODEC.fieldOf("feature").forGetter(weightedConfiguredFeature -> weightedConfiguredFeature.feature), (App)Codec.floatRange((float)0.0f, (float)1.0f).fieldOf("chance").forGetter(weightedConfiguredFeature -> Float.valueOf(weightedConfiguredFeature.chance))).apply((Applicative)instance, WeightedConfiguredFeature::new));
