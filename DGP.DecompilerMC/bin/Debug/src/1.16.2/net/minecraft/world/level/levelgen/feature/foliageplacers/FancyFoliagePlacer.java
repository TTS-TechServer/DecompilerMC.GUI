...
extends BlobFoliagePlacer {
    public static final Codec<FancyFoliagePlacer> CODEC = RecordCodecBuilder.create(instance -> FancyFoliagePlacer.blobParts(instance).apply((Applicative)instance, FancyFoliagePlacer::new));
