        ...
        try (RegionFile regionFile = new RegionFile(file2, file, true);
            ...
            for (int i = 0; i < 32; ++i) {
                ...
                for (n3 = 0; n3 < 32; ++n3) {
                    ...
                    try {
                        object2 = regionFile.getChunkDataInputStream(chunkPos);
                        object = null;
                        try {
                            if (object2 == null) {
                            ...
                            compoundTag = NbtIo.read((DataInput)object2);
                        }
                    ...
                    object2 = compoundTag.getCompound("Level");
                    object = OldChunkStorage.load((CompoundTag)object2);
                    CompoundTag compoundTag2 = new CompoundTag();
                    CompoundTag compoundTag3 = new CompoundTag();
                    compoundTag2.put("Level", compoundTag3);
                    OldChunkStorage.convertToAnvilFormat(registryHolder, (OldChunkStorage.OldLevelChunk)object, compoundTag3, biomeSource);
