        ...
        block23: {
            ...
            block21: {
                ...
                block22: {
                    ...
                    for (int i = 0; i < 2; ++i) {
                        ...
                        if (particleOptions.getType() == ParticleTypes.ENTITY_EFFECT) {
                            int f10 = this.random.nextBoolean() ? 0xFFFFFF : this.getColor();
                            int n5 = f10 >> 16 & 0xFF;
                            int n6 = f10 >> 8 & 0xFF;
                            int n7 = f10 & 0xFF;
                ...
                while ((float)n < f6) {
                    ...
                    float d2 = Mth.cos(f7) * livingEntity;
                    ...
                    if (particleOptions.getType() == ParticleTypes.ENTITY_EFFECT) {
                        ...
                        int d3 = d >> 8 & 0xFF;
                        int n3 = d & 0xFF;
                        this.level.addAlwaysVisibleParticle(particleOptions, this.getX() + (double)d2, this.getY(), this.getZ() + (double)f2, (float)n2 / 255.0f, (float)d3 / 255.0f, (float)n3 / 255.0f);
                    } else {
                        this.level.addAlwaysVisibleParticle(particleOptions, this.getX() + (double)d2, this.getY(), this.getZ() + (double)f2, (0.5 - this.random.nextDouble()) * 0.15, 0.01f, (0.5 - this.random.nextDouble()) * 0.15);
                    }
                    ++n;
                }
                break block23;
                ...
                if (object.isEmpty()) {
                    ...
                    if (!list.isEmpty()) {
                        for (LivingEntity livingEntity : list) {
                            ...
                            double d2;
                            double d3;
                            if (this.victims.containsKey(livingEntity) || !livingEntity.isAffectedByPotions() || !((d3 = (d2 = livingEntity.getX() - this.getX()) * d2 + (d = livingEntity.getZ() - this.getZ()) * d) <= (double)(f * f))) continue;
