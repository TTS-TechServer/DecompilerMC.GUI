...
implements FeatureConfiguration {
    public static final Codec<OreConfiguration> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)RuleTest.CODEC.fieldOf("target").forGetter(oreConfiguration -> oreConfiguration.target), (App)BlockState.CODEC.fieldOf("state").forGetter(oreConfiguration -> oreConfiguration.state), (App)Codec.intRange((int)0, (int)64).fieldOf("size").forGetter(oreConfiguration -> oreConfiguration.size)).apply((Applicative)instance, OreConfiguration::new));
