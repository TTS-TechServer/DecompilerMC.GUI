...
public abstract class PathNavigation {
    ...
    public void tick() {
        ...
        object = new BlockPos(vec3);
        this.mob.getMoveControl().setWantedPosition(vec3.x, this.level.getBlockState(((BlockPos)object).below()).isAir() ? vec3.y : WalkNodeEvaluator.getFloorLevel(this.level, (BlockPos)object), vec3.z, this.speedModifier);
    }
