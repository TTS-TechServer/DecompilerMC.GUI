...
implements Enemy {
    ...
    public void tick() {
        ...
        if (this.level.isClientSide) {
            ...
            float f2 = Mth.cos((float)(this.getId() * 3 + this.tickCount + 1) * 0.13f + (float)Math.PI);
            if (f > 0.0f && f2 <= 0.0f) {
                this.level.playLocalSound(this.getX(), this.getY(), this.getZ(), SoundEvents.PHANTOM_FLAP, this.getSoundSource(), 0.95f + this.random.nextFloat() * 0.05f, 0.95f + this.random.nextFloat() * 0.05f, false);
            }
            int n = this.getPhantomSize();
            float f3 = Mth.cos(this.yRot * ((float)Math.PI / 180)) * (1.3f + 0.21f * (float)n);
            float f4 = Mth.sin(this.yRot * ((float)Math.PI / 180)) * (1.3f + 0.21f * (float)n);
    ...
    extends MoveControl {
        ...
        public void tick() {
            ...
            float f2 = (float)(((Phantom)Phantom.this).moveTargetPoint.x - Phantom.this.getX());
            float f3 = (float)(((Phantom)Phantom.this).moveTargetPoint.y - Phantom.this.getY());
            float f4 = (float)(((Phantom)Phantom.this).moveTargetPoint.z - Phantom.this.getZ());
            ...
            double d4 = (double)(this.speed * Mth.cos(f9 * ((float)Math.PI / 180))) * Math.abs((double)f2 / d3);
            double d5 = (double)(this.speed * Mth.sin(f9 * ((float)Math.PI / 180))) * Math.abs((double)f4 / d3);
            double d6 = (double)(this.speed * Mth.sin(f * ((float)Math.PI / 180))) * Math.abs((double)f3 / d3);
