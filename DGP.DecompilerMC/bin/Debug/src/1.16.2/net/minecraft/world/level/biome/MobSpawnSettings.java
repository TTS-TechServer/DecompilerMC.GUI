...
public class MobSpawnSettings {
    ...
    extends WeighedRandom.WeighedRandomItem {
        public static final Codec<SpawnerData> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)Registry.ENTITY_TYPE.fieldOf("type").forGetter(spawnerData -> spawnerData.type), (App)Codec.INT.fieldOf("weight").forGetter(spawnerData -> spawnerData.weight), (App)Codec.INT.fieldOf("minCount").forGetter(spawnerData -> spawnerData.minCount), (App)Codec.INT.fieldOf("maxCount").forGetter(spawnerData -> spawnerData.maxCount)).apply((Applicative)instance, SpawnerData::new));
