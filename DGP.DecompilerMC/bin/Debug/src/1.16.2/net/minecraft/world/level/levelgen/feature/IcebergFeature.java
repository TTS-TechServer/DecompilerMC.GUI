...
extends Feature<BlockStateConfiguration> {
    ...
    public boolean place(WorldGenLevel worldGenLevel, ChunkGenerator chunkGenerator, Random random, BlockPos blockPos, BlockStateConfiguration blockStateConfiguration) {
        ...
        for (n4 = -n12; n4 < n12; ++n4) {
            for (n3 = -n12; n3 < n12; ++n3) {
                for (n2 = 0; n2 < n5; ++n2) {
                    int n13 = n = bl2 ? this.heightDependentRadiusEllipse(n2, n5, n11) : this.heightDependentRadiusRound(random, n2, n5, n11);
                    if (!bl2 && n4 >= n) continue;
                    this.generateIcebergBlock(worldGenLevel, random, blockPos, n5, n4, n2, n3, n, n12, bl2, n7, d, bl, blockState);
                }
            }
        }
        ...
        for (n4 = -n12; n4 < n12; ++n4) {
            for (n3 = -n12; n3 < n12; ++n3) {
                for (n2 = -1; n2 > -n10; --n2) {
                    ...
                    if (n4 >= n14) continue;
                    this.generateIcebergBlock(worldGenLevel, random, blockPos, n10, n4, n2, n3, n14, n, bl2, n7, d, bl, blockState);
                }
            }
        }
    ...
    private void generateCutOut(Random random, LevelAccessor levelAccessor, int n, int n2, BlockPos blockPos, boolean bl, int n3, double d, int n4) {
        ...
        double d2 = bl ? d + 1.5707963267948966 : random.nextDouble() * 2.0 * Math.PI;
        for (n6 = 0; n6 < n2 - 3; ++n6) {
