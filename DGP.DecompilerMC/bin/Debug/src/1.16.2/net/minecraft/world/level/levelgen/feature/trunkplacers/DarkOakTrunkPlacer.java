...
extends TrunkPlacer {
    public static final Codec<DarkOakTrunkPlacer> CODEC = RecordCodecBuilder.create(instance -> DarkOakTrunkPlacer.trunkPlacerParts(instance).apply((Applicative)instance, DarkOakTrunkPlacer::new));
