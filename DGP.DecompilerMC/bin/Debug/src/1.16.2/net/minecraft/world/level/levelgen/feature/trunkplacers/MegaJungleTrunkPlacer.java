...
extends GiantTrunkPlacer {
    public static final Codec<MegaJungleTrunkPlacer> CODEC = RecordCodecBuilder.create(instance -> MegaJungleTrunkPlacer.trunkPlacerParts(instance).apply((Applicative)instance, MegaJungleTrunkPlacer::new));
    ...
    public List<FoliagePlacer.FoliageAttachment> placeTrunk(LevelSimulatedRW levelSimulatedRW, Random random, int n, BlockPos blockPos, Set<BlockPos> set, BoundingBox boundingBox, TreeConfiguration treeConfiguration) {
        ...
        for (int i = n - 2 - random.nextInt(4); i > n / 2; i -= 2 + random.nextInt(4)) {
