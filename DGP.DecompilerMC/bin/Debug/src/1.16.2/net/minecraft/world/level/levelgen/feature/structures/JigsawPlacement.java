                ...
                while (iterator.hasNext() && (structurePoolElement2 = (StructurePoolElement)iterator.next()) != EmptyPoolElement.INSTANCE) {
                    for (Rotation rotation2 : Rotation.getShuffled(this.random)) {
                        ...
                        for (StructureTemplate.StructureBlockInfo structureBlockInfo3 : list) {
                            ...
                            if (n7 > 0) {
                                n9 = Math.max(n7 + 1, boundingBox4.y1 - boundingBox4.y0);
                                boundingBox4.y1 = boundingBox4.y0 + n9;
                            }
                            ...
                            n9 = poolElementStructurePiece.getGroundLevelDelta();
                            int n15 = bl4 ? n9 - n13 : structurePoolElement2.getGroundLevelDelta();
                            ...
                            poolElementStructurePiece.addJunction(new JigsawJunction(blockPos3.getX(), n8 - n5 + n9, blockPos3.getZ(), n13, projection2));
                            poolElementStructurePiece2.addJunction(new JigsawJunction(blockPos2.getX(), n8 - n12 + n15, blockPos2.getZ(), -n13, projection));
