...
extends Fireball {
    ...
    public SmallFireball(Level level, LivingEntity livingEntity, double d, double d2, double d3) {
        super((EntityType<? extends Fireball>)EntityType.SMALL_FIREBALL, livingEntity, d, d2, d3, level);
    }

    public SmallFireball(Level level, double d, double d2, double d3, double d4, double d5, double d6) {
        super((EntityType<? extends Fireball>)EntityType.SMALL_FIREBALL, d, d2, d3, d4, d5, d6, level);
    }
