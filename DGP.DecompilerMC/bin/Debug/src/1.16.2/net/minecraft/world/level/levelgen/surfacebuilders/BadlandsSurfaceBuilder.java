...
extends SurfaceBuilder<SurfaceBuilderBaseConfiguration> {
    ...
    protected void generateBands(long l) {
        ...
        for (n7 = 0; n7 < 64; ++n7) {
            if ((n7 += worldgenRandom.nextInt(5) + 1) >= 64) continue;
            this.clayBands[n7] = ORANGE_TERRACOTTA;
        }
        n7 = worldgenRandom.nextInt(4) + 2;
        for (n6 = 0; n6 < n7; ++n6) {
            n5 = worldgenRandom.nextInt(3) + 1;
            n4 = worldgenRandom.nextInt(64);
            for (n3 = 0; n4 + n3 < 64 && n3 < n5; ++n3) {
                this.clayBands[n4 + n3] = YELLOW_TERRACOTTA;
            }
        }
        n6 = worldgenRandom.nextInt(4) + 2;
        for (n5 = 0; n5 < n6; ++n5) {
            n4 = worldgenRandom.nextInt(3) + 2;
            n3 = worldgenRandom.nextInt(64);
            for (n2 = 0; n3 + n2 < 64 && n2 < n4; ++n2) {
                this.clayBands[n3 + n2] = BROWN_TERRACOTTA;
            }
        }
        n5 = worldgenRandom.nextInt(4) + 2;
        for (n4 = 0; n4 < n5; ++n4) {
            n3 = worldgenRandom.nextInt(3) + 1;
            n2 = worldgenRandom.nextInt(64);
            for (n = 0; n2 + n < 64 && n < n3; ++n) {
                this.clayBands[n2 + n] = RED_TERRACOTTA;
            }
        }
        n4 = worldgenRandom.nextInt(3) + 3;
        n3 = 0;
        for (n2 = 0; n2 < n4; ++n2) {
            n = 1;
