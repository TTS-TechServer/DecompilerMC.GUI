...
extends TrunkPlacer {
    public static final Codec<StraightTrunkPlacer> CODEC = RecordCodecBuilder.create(instance -> StraightTrunkPlacer.trunkPlacerParts(instance).apply((Applicative)instance, StraightTrunkPlacer::new));
