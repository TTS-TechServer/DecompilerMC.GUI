...
implements DataProvider {
    ...
    public void run(HashCache hashCache) {
        ...
        this.saveCollection(hashCache, path, hashMap, ModelProvider::createBlockStatePath);
        this.saveCollection(hashCache, path, hashMap2, ModelProvider::createModelPath);
    }
