...
public class VariantProperties {
    public static final VariantProperty<Rotation> X_ROT = new VariantProperty<Rotation>("x", rotation -> new JsonPrimitive((Number)((Rotation)rotation).value));
    public static final VariantProperty<Rotation> Y_ROT = new VariantProperty<Rotation>("y", rotation -> new JsonPrimitive((Number)((Rotation)rotation).value));
