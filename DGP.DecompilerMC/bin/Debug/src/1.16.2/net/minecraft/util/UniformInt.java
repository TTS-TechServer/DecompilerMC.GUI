...
public class UniformInt {
    public static final Codec<UniformInt> CODEC = Codec.either((Codec)Codec.INT, (Codec)RecordCodecBuilder.create(instance -> instance.group((App)Codec.INT.fieldOf("base").forGetter(uniformInt -> uniformInt.baseValue), (App)Codec.INT.fieldOf("spread").forGetter(uniformInt -> uniformInt.spread)).apply((Applicative)instance, UniformInt::new)).comapFlatMap(uniformInt -> {
