                    ...
                    switch ((Integer)entry.getKey()) {
                        ...
                        case 25: {
                            ...
                            while (intListIterator.hasNext()) {
                                ...
                                this.setBlock(n2, (Dynamic)NOTE_BLOCK_MAP.getOrDefault(object2, NOTE_BLOCK_MAP.get("false0")));
                            }
                            continue block14;
                        }
                        case 26: {
                            ...
                            while (intListIterator.hasNext()) {
                                ...
                                if (dynamic2 == null || (n3 = dynamic2.get("color").asInt(0)) == 14 || n3 < 0 || n3 >= 16) continue;
                                object = ChunkPalettedStorageFix.getProperty(object2, "facing") + ChunkPalettedStorageFix.getProperty(object2, "occupied") + ChunkPalettedStorageFix.getProperty(object2, "part") + n3;
                                if (!BED_BLOCK_MAP.containsKey(object)) continue;
                                this.setBlock(n2, (Dynamic)BED_BLOCK_MAP.get(object));
                            }
                            continue block14;
                        }
                        case 176: 
                        case 177: {
                            ...
                            while (intListIterator.hasNext()) {
                                ...
                                dynamic2 = this.getBlockEntity(n2 |= n);
                                object2 = this.getBlock(n2);
                                if (dynamic2 == null || (n4 = dynamic2.get("Base").asInt(0)) == 15 || n4 < 0 || n4 >= 16) continue;
                                object = ChunkPalettedStorageFix.getProperty(object2, (Integer)entry.getKey() == 176 ? "rotation" : "facing") + "_" + n4;
                                if (!BANNER_BLOCK_MAP.containsKey(object)) continue;
                                this.setBlock(n2, (Dynamic)BANNER_BLOCK_MAP.get(object));
                            }
                            continue block14;
                        }
                        case 86: {
                        ...
                        case 140: {
                            ...
                            while (intListIterator.hasNext()) {
                                ...
                                this.setBlock(n2, (Dynamic)FLOWER_POT_MAP.getOrDefault(object2, FLOWER_POT_MAP.get("minecraft:air0")));
                            }
                            continue block14;
                        }
                        case 144: {
                            ...
                            while (intListIterator.hasNext()) {
                                ...
                                object = "up".equals(string) || "down".equals(string) ? object2 + String.valueOf(dynamic2.get("Rot").asInt(0)) : object2 + string;
                                dynamic2.remove("SkullType");
                                dynamic2.remove("facing");
                                dynamic2.remove("Rot");
                                this.setBlock(n2, (Dynamic)SKULL_MAP.getOrDefault(object, SKULL_MAP.get("0north")));
                            }
                            continue block14;
                        }
                        case 64: 
                        ...
                        case 197: {
                            ...
                            while (intListIterator.hasNext()) {
                                ...
                                this.setBlock(n5, (Dynamic)DOOR_MAP.get(string + string2 + "upper" + string4 + string3 + string5));
                            }
                            continue block14;
                        }
                        case 175: {
