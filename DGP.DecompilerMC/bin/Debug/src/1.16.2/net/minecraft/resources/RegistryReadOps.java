...
extends DelegatingOps<T> {
    ...
    protected <E> DataResult<Pair<java.util.function.Supplier<E>, T>> decodeElement(T t, ResourceKey<? extends Registry<E>> resourceKey, Codec<E> codec, boolean bl) {
    ...
    private <E> DataResult<java.util.function.Supplier<E>> readAndRegisterElement(ResourceKey<? extends Registry<E>> resourceKey, WritableRegistry<E> writableRegistry, Codec<E> codec, ResourceLocation resourceLocation) {
        ...
        ((ReadCache)readCache).values.put(resourceKey2, DataResult.success((Object)supplier));
        ...
        ((ReadCache)readCache).values.put(resourceKey2, pair2);
        return pair2;
    }
