        ...
        try {
            ...
            if (worldData == null) {
                if (optionSet.has((OptionSpec)optionSpecBuilder3)) {
                    ...
                    object2 = WorldGenSettings.demoSettings(registryHolder);
                } else {
                    object = dedicatedServerSettings.getProperties();
                    object3 = new LevelSettings(((DedicatedServerProperties)object).levelName, ((DedicatedServerProperties)object).gamemode, ((DedicatedServerProperties)object).hardcore, ((DedicatedServerProperties)object).difficulty, false, new GameRules(), dataPackConfig2);
                    object2 = optionSet.has((OptionSpec)optionSpecBuilder4) ? ((DedicatedServerProperties)object).worldGenSettings.withBonusChest() : ((DedicatedServerProperties)object).worldGenSettings;
                }
                worldData = new PrimaryLevelData((LevelSettings)object3, (WorldGenSettings)object2, Lifecycle.stable());
            }
